...
class NutShellSimTop extends Module {
  ...
  BoringUtils.addSink(difftest.commit, "difftestCommit0")
  BoringUtils.addSink(difftest.isMultiCommit, "difftestMultiCommit0")
  BoringUtils.addSink(difftest.thisPC, "difftestThisPC0")
  BoringUtils.addSink(difftest.thisINST, "difftestThisINST0")
  BoringUtils.addSink(difftest.isMMIO, "difftestIsMMIO0")
  BoringUtils.addSink(difftest.isRVC, "difftestIsRVC0")
  BoringUtils.addSink(difftest.isRVC2, "difftestIsRVC20")
  BoringUtils.addSink(difftest.intrNO, "difftestIntrNO0")
  BoringUtils.addSink(difftest.r, "difftestRegs0")
  BoringUtils.addSink(difftest.priviledgeMode, "difftestMode0")
  BoringUtils.addSink(difftest.mstatus, "difftestMstatus0")
  BoringUtils.addSink(difftest.sstatus, "difftestSstatus0")
  BoringUtils.addSink(difftest.mepc, "difftestMepc0")
  BoringUtils.addSink(difftest.sepc, "difftestSepc0")
  BoringUtils.addSink(difftest.mcause, "difftestMcause0")
  BoringUtils.addSink(difftest.scause, "difftestScause0")
